import { ledgerSummarySchema } from '@shared/schemas/ledger/inquiry/ledgerSummary';

describe('inquiry/ledgerSummary', () => {
  ...
  describe('no', () => {
    describe('データ型が正しいか', () => {
      ...
      it('number型でない場合、エラーとなること', () => {
        expect(() => ledgerSummarySchema.parse({ ...validTestValue, no: '1' })).toThrow();
